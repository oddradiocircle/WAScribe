...
- **NOVEDAD**: Modo seguro para preservar archivos originales
- **NOVEDAD**: Funcionalidad de restauración para recuperar nombres originales
- **NOVEDAD**: Verificación de duplicados antes del procesamiento

## Requisitos

- Python 3.6 o superior
- Bibliotecas: pathlib, tqdm, dotenv
...
El script ahora tiene tres modos distintos de operación:
...
4. **Palabras clave**: Términos relacionados separados por comas (opcional).
...
3. Construye nombres de archivo usando componentes relevantes.
4. Añade numeración secuencial para evitar duplicados.
5. Limita la longitud del nombre a 60 caracteres para cumplir con las mejores prácticas SEO.
6. Renombra los archivos y guarda un registro de los cambios en `rename_history.json`.
...
Donde:
- Se incluyen hasta 2 palabras clave.
...
El script ahora implementa varias medidas de seguridad:
...
4. **Guía para OneDrive**: Instrucciones para recuperar desde el historial de versiones de OneDrive
...
- No analiza el contenido de la imagen para generar nombres.
- No modifica metadatos internos de la imagen.
